      ...
      body: SingleChildScrollView(
        ...
        //text header
            Container(
              ...
              padding: const EdgeInsets.only(left:35),
                child: Text(
                  "Sign into your wavelet account",
                  style: TextStyle(
        ...
        //forgot password
            Container(
              child: Padding(
                padding: const EdgeInsets.fromLTRB(238, 30.8, 44, 30),
                child: Text(
                  "Forgot password?",
                  style: TextStyle(
        ...
        //other signin options
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => SignupPage(toggleTheme: () {

...
class MaxWifiPage extends StatefulWidget {
  MaxWifiPage({
    super.key, 
  ...
  @override
  State<MaxWifiPage> createState() => _MaxWifiPageState();


}

class _MaxWifiPageState extends State<MaxWifiPage> {
